...
def show_productos(partidos: list[Partido], equipos: list[Equipo], estadios: list[Estadio]):
    while True:
        try:
...
def buscar_producto_por_nombre(estadio: Estadio):
    while True:
        try:
...
def buscar_producto_por_tipo(estadio: Estadio):
    while True:
        try:
...
def buscar_producto_por_rango_de_precio(productos: list[Producto]):
    while True:
        try:
