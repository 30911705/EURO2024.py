...
def comprar_producto(estadios: list[Estadio], boletos: list[Boleto], clientes: list[Cliente], partidos, equipos):
    while True:
        try:
...
3. No se ha verificado su asistencia al partido asociado al boleto de ese estadio""")
            ...
            # aplica_descuento_cedula_perfecta = cliente_elegido.su_cedula_es_perfecta()
